...
class Enemy_Lv1(pygame.sprite.Sprite):
    def __init__(self,backfground_size):
        ...
        self.speed = 5
        self.rect.left , self.rect.top = randint(0,self.width - self.rect.width) , randint(-3 * self.height, 0)    #进场时机
...
class Enemy_Lv3(pygame.sprite.Sprite):
    def __init__(self,backfground_size):
        ...
        self.width ,self.height = backfground_size[0],backfground_size[1]
        self.speed = 5
        self.rect.left , self.rect.top = randint(0,self.width - self.rect.width) , randint(-13 * self.height, -5 * self.height)
